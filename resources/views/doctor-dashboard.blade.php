                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 col-lg-8 col-xl-7">
                                            <img class="img-responsive" src="../assets/img/family-bg.png" alt="">
                                        </div>
                                        <div class="col-md-12 col-xl-5 align-items-end">
                                            <h2 class="card-text">The right care when you need it most</h2>
                                            <button type="button" class="btn btn-success">Schedule a Doctor now</button>
                                        </div>
