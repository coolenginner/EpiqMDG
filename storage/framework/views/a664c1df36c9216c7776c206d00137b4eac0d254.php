...
<header class="header">
				<nav class="navbar navbar-expand-lg header-nav">
					<div class="navbar-header">
						...
						<a href="index" class="navbar-brand logo">
							<img src="assets/img/logo.png" class="img-fluid" alt="Logo" width="80" height="80">
						</a>
					</div>
			...
			<!-- /Header --><?php /**PATH D:\Alex-Medical\EpiqMD\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>